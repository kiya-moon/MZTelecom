...
<summary>비동기 통신</summary>
<br>

jQuery가 아닌 Vanilla JS만을 사용하여 XMLHttpRequest(XHR) 사용하여 비동기 통신시 에러 발생

- 서버로 데이터를 전송할 때 put 방식으로 전송을 했는데 에러가 발생
